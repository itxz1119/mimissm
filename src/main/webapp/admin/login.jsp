			...
			<div id="bottom">
				<form action="${pageContext.request.contextPath}/admin/login.action" method="post">
					<table border="0px" id="table">
						<tr>
							<td class="td1">用户名：</td>
							<td><input type="text" id="name" value="admin" placeholder="Username" class="td2" name="name"></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							<td class="td1">密码：</td>
							<td><input type="password" id="pwd" value="123456" placeholder="Password" class="td2" name="pwd"></td>
						</tr>
						<tr>
							<td></td>
